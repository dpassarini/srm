...
- [docs/adr.md](file:///home/dpassarini/Prototipos/srm/docs/adr.md) — Registro de Decisões de Arquitetura (ADR) justificando as principais decisões técnicas e escolhas de escalabilidade.
