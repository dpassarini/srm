...
RSpec.describe PricingEngine::Calculator, type: :service do
  ...
  describe ".calculate_operation" do
    it "calcula lote de titulos (operacao) com sucesso" do
      receivables_data = [
        { face_value: 1000.00, due_date: (Date.today + 30.days).to_s, receivable_type_code: "duplicata", currency_code: "BRL" },
        { face_value: 2000.00, due_date: (Date.today + 60.days).to_s, receivable_type_code: "cheque", currency_code: "BRL" }
      ]
